...
load_kv_path("screens/help_screen_2.kv")

class HelpScreen_2(F.Screen):
    def on_enter(self,*args):
        if 'Help Screen_3' not in self.parent.screen_names:
            self.parent.add_widget(self.get_screen_object_from_screen_name('Help Screen_3'))
